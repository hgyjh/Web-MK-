...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Products - Viktori Dizajn</title>
		...
		<div id="top-bar" class="py-3 text-center bg-color-light">
			<div class="container clearfix">
				<div class="d-md-flex justify-content-md-between align-items-md-center">
					<h4 class="mb-2 mb-md-0 h6 fw-normal">The best furniture in one place.<span class="mx-2 text-black-50"></span></h4>
					<h4 class="mb-0 h6 fw-normal">Need Help? Call us at <a class="color" href="tel:+389-76-600-076"><u class="fw-medium">+389 76 600 076</u></a> or <a class="color" href="support@viktoridizajn.com"><u class="fw-medium">email</u></a> us.</h4>
				</div>
			</div>
		</div><!-- #top-bar end -->
		<!-- Header
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="mx-auto col-auto flex-column order-2">
							<a href="index.php" class="standard-logo"><img src="demos/furniture/images/logo.png" alt="Canvas Logo"></a>
							<a href="index.php" class="retina-logo"><img src="demos/furniture/images/logo@2x.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						...
						<nav class="primary-menu with-arrows order-lg-1 order-last px-0">
							...
							<ul class="menu-container">
								...
								<li class="menu-item mega-menu mega-menu-full">
									<a href="products.php" class="menu-link"><div>Assortment</div></a>
									...
									<div class="mega-menu-content border-bottom-0">
										<div class="container">
											<div class="row">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="livingrooms.php"><div>Living rooms</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Bedrooms</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Tables and chairs</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Epoxy tables</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Wooden tables</div></a>
														<li class="menu-item">
													    </li>
												</ul>
												<ul class="sub-menu-container mega-menu-column bg-color-light col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="single.php"><div><i class="icon-line-link"></i>Single Page</div></a>
													</li>	
												</ul>
											</div>
										</div>
				...
				<div class="container">
					...
					<div id="shop" class="shop row gutter-30 col-mb-30 mt-3">
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="single.php"><img src="demos/furniture/images/shop/2.jpg" alt="Light Grey Sofa"></a>
									<a href="single.php"><img src="demos/furniture/images/shop/2-1.jpg" alt="Light Grey Sofa"></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="single.php">Light Grey Sofa</a></h4></div>
									<h5 class="product-price fw-normal"></h5>
								</div>
							</div>
						</div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="single.php"><img src="demos/furniture/images/shop/3.jpg" alt="Celling Lights"></a>
									<a href="single.php"><img src="demos/furniture/images/shop/3-1.jpg" alt="Celling Lights"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="single.php">Celling Lights</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="single.php"><img src="demos/furniture/images/shop/4-1.jpg" alt="High Stand Chair"></a>
									<a href="single.php"><img src="demos/furniture/images/shop/4.jpg" alt="High Stand Chair"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="single.php">High Stand Chair</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="single.php"><img src="demos/furniture/images/shop/5.jpg" alt="Dining Sofa with Tea-table"></a>
									<a href="single.php"><img src="demos/furniture/images/shop/5-1.jpg" alt="Dining Sofa with Tea-table"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="single.php">Dining Sofa with Tea-table</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="single.php"><img src="demos/furniture/images/shop/6.jpg" alt="Bathroom Cloths Shelves"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="single.php">Bathroom Cloths Shelves</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="single.php"><img src="demos/furniture/images/shop/7.jpg" alt="Golden Lamp for Room"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="single.php">Golden Lamp for Room</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="single.php"><img src="demos/furniture/images/shop/8.jpg" alt="White Cuddle Chair with Cusions"></a><a href="single.php"><img src="demos/furniture/images/shop/8-1.jpg" alt="White Cuddle Chair with Cusions"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
								...
								<div class="product-desc">
									<div class="product-title mb-0"><h4 class="mb-0"><a class="fw-medium" href="single.php">White Cuddle Chair with Cusions</a></h4></div>
						...
						<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="grid-inner">
								<div class="product-image">
									<a href="single.php"><img src="demos/furniture/images/shop/9.jpg" alt="Golden Lamp for Room"></a>
									<a href="single.php"><img src="demos/furniture/images/shop/9-1.jpg" alt="Golden Lamp for Room"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="#" class="btn btn-light me-2"><i class="icon-line-shopping-cart"></i></a>
											<a href="demos/furniture/ajax/quick-view.html" class="btn btn-light" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
			...
			<div id="copyrights" class="py-3 bg-color-light">
				<div class="container">
					...
					<div class="d-flex justify-content-between op-04">
						<span>&copy; 2023 All Rights Reserved by Viktor Avramov.</span>
