...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>About - Viktori Dizajn</title>
	...
	<div id="top-bar" class="py-3 text-center bg-color-light">
		<div class="container clearfix">
			...
			<h4 class="mb-2 mb-md-0 h6 fw-normal">The best furniture in one place.<span class="mx-2 text-black-50"></span></h4>
				<h4 class="mb-0 h6 fw-normal">Need Help? Call us at <a class="color" href="tel:+389-76-600-076"><u class="fw-medium">+389 76 600 076</u></a> or <a class="color" href="email:support@viktoridizajn.com"><u class="fw-medium">email</u></a> us.</h4>
			</div>
		</div>
	</div><!-- #top-bar end -->
			...
			<div class="container">
				<div class="header-row justify-content-lg-between">
					...
					<div id="logo" class="mx-auto col-auto flex-column order-2">
						<a href="index.php" class="standard-logo"><img src="demos/furniture/images/logo.png" alt="Viktori Dizajn"></a>
						<a href="index.php" class="retina-logo"><img src="demos/furniture/images/logo@2x.png" alt="Viktori Dizajn"></a>
					</div><!-- #logo end -->
