...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Single - Viktori Dizajn</title>
		...
		<div class="side-panel-wrap">
			...
			<div class="top-cart d-flex flex-column h-100">
				<div class="top-cart-title">
					<h4>Assortment<small class="bg-color-light icon-stacked text-center rounded-circle color">2</small></h4>
				</div>
							...
							<ul class="menu-container">
								<li class="menu-item">
									...
									<ul class="sub-menu-container">
										<li class="menu-item">
											<a class="menu-link" href="index.php"><div>Home Page 1</div></a>
										</li>
										<li class="menu-item">
								...
								<li class="menu-item mega-menu mega-menu-full current">
									<a href="products.php" class="menu-link"><div>Shop</div></a>
										...
										<div class="container">
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Sofa</div></a>

														<!-- Menu Sub DropDown
														============================================= -->
														<ul class="sub-menu-container mega-menu-dropdown">
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>Sofa Set</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>Single Seater</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>Recliner</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>Sofa Cum Bed</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>BeanBag</div></a>
															</li>
														</ul>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Chairs</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Beds</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Wardrobe</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>Tables</div></a>
													</li>
												</ul>
												<ul class="sub-menu-container mega-menu-column col-lg-auto">
													<li class="menu-item">
														<a class="menu-link" href="products.php"><div>More</div></a>
														<ul class="sub-menu-container mega-menu-dropdown">
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>Kids Room</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>Mattress</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>Lighting</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>Pillows</div></a>
															</li>
															<li class="menu-item">
																<a class="menu-link" href="products.php"><div>FlowerPot</div></a>
															</li>
														</ul>
													</li>
												</ul>
						...
						<div class="col-lg-2 col-md-3 col-6">
							<div class="widget widget_links widget-li-noicon">
								...
								<ul class="list-unstyled iconlist ms-0">
									...
									<li><a href="https://instagram.com/viktoridizajn/" target="_blank"><i class="icon-instagram"></i> Instagram</a></li>
									<li><a href="https://twitter.com/" target="_blank"><i class="icon-twitter"></i> Twitter</a></li>
									<li><a href="https://youtube.com" target="_blank"><i class="icon-youtube"></i> YouTube</a></li>
									<li><a href="https://wa.me/+38976600076"><i class="icon-whatsapp"></i> WhatsApp</a></li>
								</ul>
